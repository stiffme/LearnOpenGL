...
public class Textures_Exe3 extends OGLApplicationGL33 {
    ...
    protected boolean applicationInitAfterContext() {
        ...
        try {
            ...
            glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
            glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
            float[] borderColor = new float[]{1.0f,0.0f,0.0f, 1.0f};
    ...
    protected void update(float elapsed) {
        if(m_saturateLoc != -1) {
            ...
            glUseProgram(m_program);
            glUniform1f(m_saturateLoc, 0.5f);
        }
    }
    ...
    public static void main(String[] args)  {
        OGLApplicationAbstract application = new Textures_Exe3();
        application.run();
    }
}
