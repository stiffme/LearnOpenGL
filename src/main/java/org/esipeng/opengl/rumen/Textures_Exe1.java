...
public class Textures_Exe1 extends OGLApplicationGL33 {
    ...
    protected boolean applicationInitAfterContext() {
        try {
            m_program = compileAndLinkProgram("Textures/vertex.glsl", "Textures/fragment_exe1.glsl");
        } catch (Exception e)   {
            e.printStackTrace();
            return false;
        }
    ...
    public static void main(String[] args)  {
        OGLApplicationAbstract application = new Textures_Exe1();
        application.run();
    }
}
