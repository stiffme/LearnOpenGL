...
public class Transforms extends OGLApplicationGL33 {
    ...
    protected void draw() {
        ...
        if(m_transformLoc != -1)    {
            ...
            m_mvp.translate(0.5f,-0.5f,0.0f);
            m_mvp.rotate((float)glfwGetTime(),0.0f,0.0f,1.0f);
            ...
            m_mvp.identity();
            m_mvp.translate(-0.5f, 0.5f,0.0f);
            m_mvp.scale((float)Math.abs(Math.sin(glfwGetTime())));
    ...
    public static void main(String[] args)  {
        OGLApplicationAbstract application = new Transforms();
        application.run();
    }
}
