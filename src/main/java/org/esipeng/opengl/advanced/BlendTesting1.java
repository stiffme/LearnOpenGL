...
public class BlendTesting1 extends OGLApplicationGL33 {
    ...
    protected boolean applicationInitAfterContext() {
        ...
        try{
            ...
            if(!textureLoader.loadFromResource("advanced/blend/grass.png"))
                return false;
    ...
    protected void draw() {
        ...
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D, textureGrass);
        for( Vector3f vege : vegetations)   {
            mModel.identity().translate(vege);
            mvpManager.setValue("model", mModel);
            glDrawArrays(GL_TRIANGLES, 0, 6);
        }
    ...
    public static void main(String[] args)  {
        OGLApplicationAbstract application = new BlendTesting1();
        application.run();
    }
}
